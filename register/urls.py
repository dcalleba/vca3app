...
urlpatterns = [
    ...
    path('contact3/', views.contact2, name='contact2'),
    # path('dany/', views.dany,name='dany'),
    # path('dany/<slug:start>', views.dany,name='dany'),
    path('demo/', views.demo,name='demo'),
    path('index/', views.index,name='index'),
    path('', views.index,name='index'),
    path('cv/', views.cv,name='cv'),
    path('bastest/', views.bastest,name='bastest'),
    path('exhibitions/', views.exhibitions, name='exhibitions/'),
    path('publications/<slug:start>', views.publications,name='publications'),
    path('publications/', views.publications, name='publications/'),
    path('exhibitions/<slug:start>', views.exhibitions,name='exhibitions'),
    path('exhibitions/', views.exhibitions, name='exhibitions/'),
    ...
    path('demo/<slug:date_projet>/<slug:projet>/<slug:categorie>', views.demo, name='demo'), 
